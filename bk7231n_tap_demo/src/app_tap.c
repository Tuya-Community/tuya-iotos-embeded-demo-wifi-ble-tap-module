 ...
 * @LastEditTime: 2021-03-23 14:46:41
 */
...
OPERATE_RET app_tap_init(IN APP_MODE mode)
{
...
VOID app_report_all_dp_status(VOID)
{
    ...
    dp_arr[0].dpid = DPID_SENSOR_STATE;
    dp_arr[0].type = PROP_ENUM;
    dp_arr[0].time_stamp = 0;
    dp_arr[0].value.dp_value = app_ctrl_data.sensor_state;
